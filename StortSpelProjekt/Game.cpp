...
void Game::loadObjects()
{
	...
	spaceShip = new SpaceShip(DirectX::SimpleMath::Vector3(10, 14, 10), orientToPlanet(DirectX::SimpleMath::Vector3(10, 14, 10)), planetGravityField.calcGravFactor(DirectX::SimpleMath::Vector3(10, 14, 10)), 3, DirectX::SimpleMath::Vector3(2, 2, 2));
