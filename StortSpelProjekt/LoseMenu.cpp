...
LoseMenu::LoseMenu(int& currentTeam) : manager(GPU::device)
{
    ...
    {
        manager.loadMeshAndBoneData("../Meshes/anim/character2_idle.fbx");
        manager.AdditionalAnimation("../Meshes/anim/character2_Sad1.fbx", "../Meshes/anim/character2_idle.fbx");
        manager.AdditionalAnimation("../Meshes/anim/character2_Sad2.fbx", "../Meshes/anim/character2_idle.fbx");
        manager.AdditionalAnimation("../Meshes/anim/character2_Sad3.fbx", "../Meshes/anim/character2_idle.fbx");
