...
void Game::loadObjects()
{
	...
	//this->tmp->setSrv(this->manager.getSrv("playerTexture.png"));
	//
	//
	...
	//physWolrd.addPhysComponent(tmp, reactphysics3d::CollisionShapeName::BOX);
	//
	//tmp->getPhysComp()->setPosition({ -100, 0, 100 });
